...
public class MainActivity extends Activity {
	...
	private TextView adaFeatureTextView;
	private TextView adaAccelConfTextView;
	private TextView adaConfTextView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int checkGooglePlayServices =  GooglePlayServicesUtil.isGooglePlayServicesAvailable(Global.context);
	    ...
	    adaFeatureTextView = (TextView) findViewById(R.id.adaAccelFeature);
	    adaAccelConfTextView = (TextView) findViewById(R.id.adaAccelConf);
	    adaConfTextView = (TextView) findViewById(R.id.adaConf);
	...
	public void updatePredictionOnUI(int adaPrediction, int googlePrediction) {
		...
		adaFeatureTextView.setText(Global.adaFeatureString);
		adaConfTextView.setText(Global.adaConfString);
		adaAccelConfTextView.setText(Global.adaAccelConfString);
